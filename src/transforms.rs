...
// This outputs a right-handed erspective matrix that ranges in depth from -1 to 1
#[allow(dead_code)]
...
// This outputs a left-handed erspective matrix that ranges in depth from -1 to 1
#[allow(dead_code)]
...
// This outputs a right-handed erspective matrix that ranges in depth from 0 to 1
#[allow(dead_code)]
...
mod transform_tests 
{
	...
	#[allow(dead_code)] const TEST_EYE : Point3<f32> = Point3::new(0.0, 0.0, -2.0);
	#[allow(dead_code)] const TEST_TARGET : Point3<f32> = Point3::new(0.0, 0.0, 0.0);
	#[allow(dead_code)] const UP : Vector3<f32> = Vector3::new(0.0, 1.0, 0.0);
	...
	#[allow(dead_code)] const EXPECTED_A : f32 = 0.803333223;
	#[allow(dead_code)] const EXPECTED_B : f32 = 1.42814803;
	#[allow(dead_code)] const EXPECTED_C : f32 = 1.00200200;
	#[allow(dead_code)] const EXPECTED_D : f32 = 1.00000000;
	#[allow(dead_code)] const EXPECTED_E : f32 = 0.200200200;

	// calculated using doubles and result in float (slightly more precise on a)
	#[allow(dead_code)] const EXPECTED_A_FROM_DBL : f32 = 0.803333282;
	#[allow(dead_code)] const EXPECTED_B_FROM_DBL : f32 = 1.42814803;
	#[allow(dead_code)] const EXPECTED_C_FROM_DBL : f32 = 1.00200200;
	#[allow(dead_code)] const EXPECTED_D_FROM_DBL : f32 = 1.00000000;
	#[allow(dead_code)] const EXPECTED_F_FROM_DBL : f32 = 0.200200200;
