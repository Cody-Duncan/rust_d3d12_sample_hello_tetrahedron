...
impl CD3D12_CPU_DESCRIPTOR_HANDLE
{
	pub fn new() -> Self
	{
		Self
		{
			0 : d3d12::D3D12_CPU_DESCRIPTOR_HANDLE { ptr : 0 }
		}
	}
	...
	pub fn offset_cpu_descriptor_handle(
		...
		offset_index : i32, 
		descriptor_increment_size : u32) -> d3d12::D3D12_CPU_DESCRIPTOR_HANDLE
	{
		...
		return d3d12::D3D12_CPU_DESCRIPTOR_HANDLE { ptr : result };
	}

	pub fn from_offset(
		other : &d3d12::D3D12_CPU_DESCRIPTOR_HANDLE, 
		offset_index : i32, 
...
impl CD3D12_GPU_DESCRIPTOR_HANDLE
{
	pub fn new() -> Self
	{
		Self
		{
			0 : d3d12::D3D12_GPU_DESCRIPTOR_HANDLE { ptr : 0 }
		}
	}
	...
	pub fn offset_gpu_descriptor_handle(
		handle : &d3d12::D3D12_GPU_DESCRIPTOR_HANDLE, 
		offset_index : i32, 
		descriptor_increment_size : u32) -> d3d12::D3D12_GPU_DESCRIPTOR_HANDLE
	{
		let ptr_64 = handle.ptr as i64;
		let offset_index_64 = offset_index as i64;
		let descriptor_increment_size_64 = descriptor_increment_size as i64;
		let result = (ptr_64 + offset_index_64 * descriptor_increment_size_64) as u64;
		return d3d12::D3D12_GPU_DESCRIPTOR_HANDLE { ptr : result };
	}

	pub fn from_offset(
		other : &d3d12::D3D12_GPU_DESCRIPTOR_HANDLE, 
		offset_index : i32, 
		descriptor_increment_size : u32) -> Self
	{
		Self
